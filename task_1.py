...
class ExtendedCase(Case):
    def __init__(self, test_case_id, name, step_description, expected_result, precondition: int, enviroment: int):
        super().__init__(test_case_id, name, step_description, expected_result)
        self.precondition = precondition #add type string
        self.enviroment = enviroment #add type string
